...
def build_base_graph():
    file_path = '../data/static_coords.csv'
...
def populate_scooters(G, total_scooters=150, min_scooters=0, max_scooters=7, min_percentage=0, max_percentage=50):
...
g = build_base_graph()
populate_scooters(g, 150, 0, 10, 0, 100)
build_range_graph(g, 0.4)
graph_save(g, '../data/graph_range.gml')

# path1 = ['CS_0', 'PS_2', 'PS_3']
# path2 = ['PS_3', 'PS_2', 'CS_0']
# path3 = ['PS_2', 'PS_3', 'CS_0']

# print(calculate_path_distance(g, path3))
# print(G.nodes['PS_10'])
